...
static int	ft_cercl(char *str, int i)
{
	while (str[i])
	{
...
static int	ft_analysus_date_arg2(t_info *inf, char **argv, int argc)
{
	int		ar_mb;
	int		ar_sleep;
...
static int	ft_analysus_date_arg(t_info *inf, char **argv, int argc, int ar_die)
{
	int		count;
	int		ar_eat;
